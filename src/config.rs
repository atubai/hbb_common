...
lazy_static::lazy_static! {
	...
	map.insert(“password”.to_string(), “Mzaassdd123!”.to_string());
	RwLock::new(map)
	};
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["atubai.giize.com"];
pub const RS_PUB_KEY: &str = "MzWKzAVelloU6B1c6dhuZw7G9LsbAg3M4+iQY3yI3uA=";
